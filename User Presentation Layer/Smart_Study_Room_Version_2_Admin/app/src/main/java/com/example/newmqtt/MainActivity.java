...
public class MainActivity extends AppCompatActivity {
    ...
    TextView subText_1, subText_2, subText_3, subText_4, subText_5, subText_6, subText_7, subText_8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subText_4 = (TextView)findViewById(R.id.textView4);
        subText_5 = (TextView)findViewById(R.id.textView5);
        subText_6 = (TextView)findViewById(R.id.textView6);
        subText_7 = (TextView)findViewById(R.id.textView8);
        subText_8 = (TextView)findViewById(R.id.textView7);
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                ...
                switch (topic.toString()) {
                    ...
                    case "Composition/User/U38/0/1/PeopleCount":
                        ...
                        break;
                    case "Composition/User/U38/0/1/LightStatus":
                        subText_4.setText(new String(message.getPayload()));
                        break;
                    case "Composition/User/U38/0/1/BlindStatus":
                        subText_5.setText(new String(message.getPayload()));
                        break;
                    case "Composition/User/U38/0/1/HeaterStatus":
                        subText_6.setText(new String(message.getPayload()));
                        break;
                    case "Composition/User/U38/0/1/AcStatus":
                        subText_7.setText(new String(message.getPayload()));
                        break;
                    case "Composition/User/U38/0/1/DustbinStatus":
                        subText_8.setText(new String(message.getPayload()));
                        break;
                    default:
                        return;
                }
